...
const SweetTasteEquation: React.FC = () => {
      ...
      <div className="flex-1 w-full grid grid-cols-1 lg:grid-cols-12 overflow-hidden">
        ...
        <div className="lg:col-span-3 h-full bg-white border-r border-slate-200 p-6 overflow-y-auto flex flex-col gap-8 z-10 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            ...
            <div className="flex items-center justify-between">
                <h2 className="text-xl font-bold text-slate-800">Sweet Taste Equation</h2>
            </div>
            
            {/* Equation Display */}
            <div className="bg-slate-900 rounded-xl p-6 text-center shadow-lg relative overflow-hidden flex flex-col items-center justify-center min-h-[140px]">
                <h3 className="text-xs font-mono text-slate-400 mb-0 uppercase tracking-widest z-10">Governing Equation (Eq 1)</h3>
                <div className="flex items-center justify-center w-full font-serif text-white text-[0.6rem] md:text-[0.72rem] lg:text-[0.9rem] italic whitespace-nowrap z-10 font-bold tracking-wide -mt-2">
                    <InlineMath math="\color{#818cf8}{\boldsymbol{\Delta\Delta G}} = \mathbf{10.13} \times \mathbf{\lg}\mathit{Sw} - \mathbf{20.72}" />
                </div>
            </div>
...
export default SweetTasteEquation;

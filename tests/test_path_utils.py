...
class TestToRelative:
    def test_absolute_path_under_base_dir(self):
        ...
        assert result == "SweetSeek_paper_database/sweetness/papers/test.pdf"
    ...
    def test_dual_protein_path_from_different_machine(self):
        ...
        result = to_relative(foreign_path)
        assert result == "SweetSeek_paper_database/dual_protein/papers/file.pdf"
...
class TestToAbsolute:
    def test_relative_path(self):
        ...
        expected = str(PAPER_DATABASE_ROOT / "sweetness" / "papers" / "test.pdf")
...
class TestNormalizeForStorage:
    def test_local_absolute_path(self):
        ...
        assert result == "SweetSeek_paper_database/sweetness/papers/file.pdf"
    ...
    def test_server_absolute_path(self):
        ...
        assert result == "SweetSeek_paper_database/dual_protein/papers/protein.pdf"

    def test_idempotent(self):
        rel_path = "SweetSeek_paper_database/sweetness/papers/test.pdf"
        assert normalize_for_storage(rel_path) == rel_path
        assert normalize_for_storage(normalize_for_storage(rel_path)) == rel_path

    def test_roundtrip(self):
        original_rel = "SweetSeek_paper_database/sweetness/papers/test.pdf"
